...
def ReddVendFunc( parent, call_fit = True, set_sizer = True ):
    ...
    item6 = wx.StaticText( parent, ID_TEXT, "Data doc.", wx.DefaultPosition, wx.DefaultSize, 0 )
    item4.Add( item6, 0, wx.ALIGN_CENTER_VERTICAL|wx.LEFT|wx.RIGHT, 5 )

    item7 = wx.StaticText( parent, ID_TEXT, "Vendite dal:", wx.DefaultPosition, wx.DefaultSize, 0 )
    ...
    item12 = wx.StaticBox( parent, -1, "Limiti" )
    ...
    item15 = wx.StaticText( parent, ID_TEXT, "Min.", wx.DefaultPosition, wx.DefaultSize, 0 )
    item13.Add( item15, 0, wx.ALIGN_RIGHT|wx.ALIGN_CENTER_VERTICAL|wx.LEFT, 5 )

    item16 = wx.StaticText( parent, ID_TEXT, "Max.", wx.DefaultPosition, wx.DefaultSize, 0 )
    item13.Add( item16, 0, wx.ALIGN_RIGHT|wx.ALIGN_CENTER_VERTICAL|wx.LEFT|wx.RIGHT, 5 )
    ...
    item18 = NumCtrl(parent, ID_RICA1, integerWidth=5, fractionWidth=2, name='rica1')
    item13.Add( item18, 0, wx.ALIGN_RIGHT|wx.ALIGN_CENTER_VERTICAL|wx.LEFT|wx.RIGHT|wx.BOTTOM, 5 )

    item19 = NumCtrl(parent, ID_RICA2, integerWidth=5, fractionWidth=2, name='rica2')
    item13.Add( item19, 0, wx.ALIGN_RIGHT|wx.ALIGN_CENTER_VERTICAL|wx.LEFT|wx.RIGHT|wx.BOTTOM, 5 )

    item20 = wx.StaticText( parent, ID_TEXT, "Magine:", wx.DefaultPosition, wx.DefaultSize, 0 )
    item13.Add( item20, 0, wx.ALIGN_RIGHT|wx.ALIGN_CENTER_VERTICAL|wx.LEFT|wx.BOTTOM, 5 )

    item21 = NumCtrl(parent, ID_MARG1, integerWidth=5, fractionWidth=2, name='marg1')
    item13.Add( item21, 0, wx.ALIGN_RIGHT|wx.ALIGN_CENTER_VERTICAL|wx.LEFT|wx.RIGHT|wx.BOTTOM, 5 )

    item22 = NumCtrl(parent, ID_MARG2, integerWidth=5, fractionWidth=2, name='marg2')
    item13.Add( item22, 0, wx.ALIGN_RIGHT|wx.ALIGN_CENTER_VERTICAL|wx.LEFT|wx.RIGHT|wx.BOTTOM, 5 )
    ...
    item25 = wx.StaticBox( parent, -1, "Selezioni" )
    item24 = wx.StaticBoxSizer( item25, wx.VERTICAL )
    
    item26 = wx.FlexGridSizer( 0, 2, 0, 0 )
    
    item27 = wx.StaticText( parent, ID_TEXT, "Causale:", wx.DefaultPosition, wx.DefaultSize, 0 )
    item26.Add( item27, 0, wx.ALIGN_RIGHT|wx.ALIGN_CENTER_VERTICAL|wx.LEFT|wx.BOTTOM, 5 )

    item28 = alib.LinkTableDocMagazz(parent, ID_TIPDOC, 'id_tipdoc')
    item26.Add( item28, 0, wx.GROW|wx.ALIGN_CENTER_VERTICAL|wx.LEFT|wx.RIGHT|wx.BOTTOM, 5 )

    item29 = wx.StaticText( parent, ID_TEXT, "Cliente:", wx.DefaultPosition, wx.DefaultSize, 0 )
    item26.Add( item29, 0, wx.ALIGN_RIGHT|wx.ALIGN_CENTER_VERTICAL|wx.LEFT, 5 )

    item30 = alib.LinkTableCliente(parent, ID_PDC, 'id_pdc')
    ...
    item32 = wx.StaticBox( parent, -1, "Escludi" )
    item31 = wx.StaticBoxSizer( item32, wx.HORIZONTAL )
    
    item33 = UnoZeroCheckBox( parent, ID_ESCMOVANN, "Movimenti annullati", wx.DefaultPosition, wx.DefaultSize, 0 )
    item33.SetValue( True )
    item33.SetName( "escmovann" )
    item31.Add( item33, 0, wx.ALIGN_CENTER|wx.RIGHT, 10 )

    item34 = UnoZeroCheckBox( parent, ID_ESCDOCANN, "Documenti annullati", wx.DefaultPosition, wx.DefaultSize, 0 )
    item34.SetValue( True )
    item34.SetName( "escdocann" )
    item31.Add( item34, 0, wx.ALIGN_CENTER|wx.RIGHT, 5 )

    item35 = UnoZeroCheckBox( parent, ID_ESCDOCACQ, "Documenti acquisiti", wx.DefaultPosition, wx.DefaultSize, 0 )
    item35.SetValue( True )
    item35.SetName( "escdocacq" )
    item31.Add( item35, 0, wx.ALIGN_CENTER, 5 )

    item23.Add( item31, 0, wx.GROW|wx.ALIGN_CENTER_VERTICAL|wx.RIGHT|wx.BOTTOM, 5 )

    item23.AddGrowableCol( 0 )

    item1.Add( item23, 0, wx.GROW|wx.ALIGN_CENTER_VERTICAL, 5 )

    item36 = wx.Button( parent, ID_BUTUPD, "Aggiorna", wx.DefaultPosition, wx.DefaultSize, 0 )
    item36.SetDefault()
    item36.SetName( "butupd" )
    item1.Add( item36, 0, wx.ALIGN_BOTTOM|wx.ALIGN_CENTER_HORIZONTAL|wx.RIGHT|wx.TOP|wx.BOTTOM, 5 )

    item1.AddGrowableCol( 2 )

    item0.Add( item1, 0, wx.GROW|wx.ALIGN_CENTER_VERTICAL, 5 )

    item37 = wx.StaticText( parent, ID_TEXT, "Elenco delle vendite:", wx.DefaultPosition, wx.DefaultSize, 0 )
    item37.SetForegroundColour( wx.BLUE )
    item0.Add( item37, 0, wx.GROW|wx.ALIGN_CENTER_VERTICAL|wx.LEFT|wx.RIGHT|wx.TOP, 5 )

    item38 = wx.Panel( parent, ID_PANGRIDVEN, wx.DefaultPosition, [900,400], wx.SUNKEN_BORDER )
    item38.SetName( "pangridven" )
    ...
    item41 = wx.StaticText( parent, ID_TEXT, "Tot.Ricavo:", wx.DefaultPosition, wx.DefaultSize, 0 )
    item40.Add( item41, 0, wx.ALIGN_RIGHT|wx.ALIGN_CENTER_VERTICAL|wx.LEFT|wx.TOP, 5 )

    item42 = wx.StaticText( parent, ID_TEXT, "Tot.Costo:", wx.DefaultPosition, wx.DefaultSize, 0 )
    item40.Add( item42, 0, wx.ALIGN_RIGHT|wx.ALIGN_CENTER_VERTICAL|wx.LEFT|wx.TOP, 5 )

    item43 = wx.StaticText( parent, ID_TEXT, "Tot.Utile:", wx.DefaultPosition, wx.DefaultSize, 0 )
    item40.Add( item43, 0, wx.ALIGN_RIGHT|wx.ALIGN_CENTER_VERTICAL|wx.LEFT|wx.TOP, 5 )

    item44 = wx.StaticText( parent, ID_TEXT, "%Margine", wx.DefaultPosition, wx.DefaultSize, 0 )
    item40.Add( item44, 0, wx.ALIGN_RIGHT|wx.ALIGN_CENTER_VERTICAL|wx.LEFT|wx.TOP, 5 )

    item45 = wx.StaticText( parent, ID_TEXT, "%Ricarica", wx.DefaultPosition, wx.DefaultSize, 0 )
    item40.Add( item45, 0, wx.ALIGN_RIGHT|wx.ALIGN_CENTER_VERTICAL|wx.LEFT|wx.TOP, 5 )

    item46 = NumCtrl(parent, ID_TOTRICAVO, name='totricavo', integerWidth=8, fractionWidth=2); item46.Disable()
    item40.Add( item46, 0, wx.ALIGN_CENTER|wx.LEFT|wx.BOTTOM, 5 )

    item47 = NumCtrl(parent, ID_TOTCOSTO, name='totcosto', integerWidth=8, fractionWidth=2); item47.Disable()
    item40.Add( item47, 0, wx.ALIGN_CENTER|wx.LEFT|wx.BOTTOM, 5 )

    item48 = NumCtrl(parent, ID_TOTUTILE, name='totutile', integerWidth=8, fractionWidth=2); item48.Disable()
    item40.Add( item48, 0, wx.ALIGN_CENTER|wx.LEFT|wx.BOTTOM, 5 )

    item49 = NumCtrl(parent, ID_PRCMAR, name='prcmar', integerWidth=4, fractionWidth=2); item49.Disable()
    item40.Add( item49, 0, wx.ALIGN_CENTER|wx.LEFT|wx.BOTTOM, 5 )

    item50 = NumCtrl(parent, ID_PRCRIC, name='prcric', integerWidth=4, fractionWidth=2); item50.Disable()
    item40.Add( item50, 0, wx.ALIGN_CENTER|wx.LEFT|wx.BOTTOM, 5 )

    item39.Add( item40, 0, wx.GROW|wx.ALIGN_CENTER_VERTICAL, 5 )

    item51 = wx.Button( parent, ID_BUTPRT, "Lista", wx.DefaultPosition, wx.DefaultSize, 0 )
    item51.SetName( "butprt" )
    item39.Add( item51, 0, wx.ALIGN_RIGHT|wx.LEFT|wx.RIGHT|wx.BOTTOM, 5 )
